...
//
    ...
    public void getSummaryDiary(){
        ...
        &:长线需要明确一种趋势的入口和出口，比如我们要做周线的一笔趋势，通常入口信号就是30分钟3买的形成，出口信号是30分钟的三卖形成
          ...
          A.【30分钟3买有机会时】满足此调整执行下一步,这个过程是为了确定周线开始上涨一笔，除了3买也可以通过日线1买确认止跌 但是要放量大阳线才行
                  ||
          B.【参考黄金分割位，等待5分钟1买买入部分仓位，1.不能出现5分钟3卖 2.需要严格止损防止三买失败】操作完成执行下一步，如果失败转向步骤A
                  ||
          C.【等待30分钟的一卖出局，1.参考5分钟的一卖  2.或者一旦出现1分钟3卖5分钟反弹出局】操作完成执行下一步
                  ||
          D.【等待日线杀跌完成形成2买或者3买，1.30分钟的1买或者30分钟一笔跌到位参考5分钟1买  2.5分钟出3买后的30分钟2买】操作完成执行下一步，这个过程要防止出现30分钟出现3卖，一旦出现整段趋势可能就终结了
                  ||
          E.【2买3买要参考中枢上轨压力，1.5分钟1卖出局  2.5分钟3卖出局】这个位置要重点关注日线的止损位置，一旦跌破可能也是整个趋势的终结
            【这个过程一旦出现3卖，如果杀跌幅度不大且依旧处于30分钟中枢内部，是有可能继续形成30分钟类2买的，但是必须保证不能再破5分钟新低，不然要卖出做T】
                  ||
          F.【如果E步骤上涨正常，重点关注中枢上轨压力T，重点关注30分钟是否能出3买】这个过程主要是T
                  ||
                  ||
                  ||
        */
