...
//        subList1.add(new StockInfo("<>士兰微",14.73,700,14.22,6,"20190819  09:41","15分钟回调低位再买回"));
//        subList1.add(new StockInfo("<>士兰微",14.60,700,14.50,7,"20190819  09:41","15分钟回调低位再买回"));
//        subList1.add(new StockInfo("<>士兰微",14.74,700,15.53,9,"20190822  09:51","1.15分钟回调后有反弹，可能跟股北方华创2.30号日线压力位卖出"));
//        subList1.add(new StockInfo("<>士兰微",14.45,700,14.12,5,"20190827  09:41","1.外围利空影响，减仓防范60分钟大跌风险2.重新买回有反弹趋势"));
//        subList1.add(new StockInfo("<>士兰微",14.69,700,14.78,2,"20190829  10:41","1.5分钟前高有回调趋势卖空，2.5分钟回抽零轴附近买回"));
//       -----------------------------------------------------------
//       |[1.77%][6/10]总结：以15分钟及以上级别判断做T高低点
//       ------------------------------------------------------------
...
//        subList1.add(new StockInfo("<>士兰微",15.08,700,15.21,5,"20190830  14:09","1.5分钟回调过大，防范60分钟开始杀跌，2.5分钟低位T回"));
//        subList1.add(new StockInfo("<>士兰微",15.50,700,15.47,2,"20190902  13:19","1.大盘1分钟有背驰风险卖出T,2.大盘继续强势原价买回"));
...
//        subList1.add(new StockInfo("<>士兰微",16.13,700,16.26,7,"20190909  13:44","1.15分钟中枢震荡上轨卖空T，2.再次低位买回"));
//        subList1.add(new StockInfo("<>士兰微",0,700,16.51,1,"20190911  14:59","1.15分钟尾盘放量爆拉中枢上轨卖空，2."));
//        subList1.add(new StockInfo("<>士兰微",0,700,17.53,1,"20190912  14:01","1.已经达到目标价位,继续分多次卖出，2."));
//        -----------------------------------------------------------
//       |[4.54%][4/9]总结：需要增加一点耐性
//       ------------------------------------------------------------
...
//        subList4.add(new StockInfo("紫光国微",49.45,200,49.04,2,"20190822  10:06","1.卖空T防范5分钟反创新低，60分钟加速调整2.有反弹趋势，买回T"));
//        subList4.add(new StockInfo("紫光国微",50.84,200,51.19,9,"20190827  13:15","1.1分钟高位前高背驰区间卖空2.5分钟回调低位买回做T部分"));
//        subList4.add(new StockInfo("紫光国微",51.05,200,50.88,9,"20190828  11:15","1.防范15分钟回抽0轴2.5分钟依旧处于中枢震荡再买回"));
//        subList4.add(new StockInfo("紫光国微",55.09,200,54.24,5,"20190828  10:25","1.日线前高并且5分钟背驰区域附近卖空 2，板块涨停个股较多买入T回防止明天大盘高开"));
//        -----------------------------------------------------------
//       |[0.2%][3/6]总结：定力不够，需要耐性等待T
//       ------------------------------------------------------------
        return list;
    }

    public static List<List<StockInfo>> longTermTrackAll_9(){
        List<List<StockInfo>> list = new ArrayList<>();
        List<StockInfo> subList1 = new ArrayList<>();
        List<StockInfo> subList2= new ArrayList<>();
        List<StockInfo> subList3 = new ArrayList<>();
...
//       ------------------------------------------------------------
        list.add(subList1);
        subList5.add(new StockInfo("四维图新",17.27,600,16.75,1,"20190906  13:47","1.大盘回落防范买空，2，继续走强，15分钟突破走势再次买回"));
        subList5.add(new StockInfo("四维图新",17.39,600,17.64,1,"20190909  13:15","1.15分钟3买回落之前卖空，2，5分钟低位接回"));
        subList5.add(new StockInfo("四维图新",16.42,600,16.74,4,"20190917  14:25","1.防范风险卖空T，2，买入做T部分"));
        subList5.add(new StockInfo("四维图新",17.20,600,16.62,6,"20190919  13:14","1.防范风险卖空T，2，板块有利好高开5分钟回调再次买回"));
        subList5.add(new StockInfo("四维图新",17.20,600,16.62,6,"20190919  13:14","1.防范风险卖空T，2，板块有利好高开5分钟回调再次买回"));
        subList5.add(new StockInfo("四维图新",18.21,600,18.31,6,"20190923  14:14","1.60分钟利好冲击卖空防范风险，2.回调到支撑继续买回T"));
...
//       ------------------------------------------------------------
        ...
        subList4.add(new StockInfo("紫光国微",55.46,200,55.54,1,"20190917  14:45","1.博尾盘反弹买多 2，收盘再卖出T"));
        subList4.add(new StockInfo("紫光国微",52.73,200,51.70,1,"20190926  11:15","1.5分钟背驰趋势买入做T"));
        subList4.add(new StockInfo("紫光国微",53.39,200,53.51,1,"201901014  10:15","1.防止冲高回落卖出做T 2.5分钟3买位置买回T"));
        subList4.add(new StockInfo("紫光国微",51.93,200,51.85,1,"201901016  14:05","1.一分钟背驰，博5分钟反弹，大盘也出现背驰趋势，买入T 2.为按预期反弹，卖出T"));
        ...
        subList2.add(new StockInfo("<>数据港",36.20,300,36.30,2,"20191014  13:25","1.个股反弹60分钟压力位卖空.  2.5分钟3买附近买回T"));
        subList2.add(new StockInfo("<>数据港",34.95,300,35.80,6,"20191018  10:25","1.退出等待，防范大盘砸盘风险.  2.博大盘5分钟背驰反弹买回T"));
        subList2.add(new StockInfo("<>数据港",34.98,300,35.80,6,"20191018  10:25","1.退出等待，防范大盘砸盘风险.  2.大盘5分钟有背驰概率买回做T"));
    ...
    public static List<List<StockInfo>> longTermTrackAll_11(){
        ...
        List<StockInfo> subList4 = new ArrayList<>();
//       ------------------------------------------------------------
//        subList1.add(new StockInfo("中国国航",8.74,1200,8.70,1,"20190111  10:25","1.15分钟2卖之后的杀跌卖空T  2.长时间不跌破，大盘有1分钟背驰趋势再次买回"));

        list.add(subList1);


//        subList2.add(new StockInfo("<>士兰微",0,300,0,2,"20191022  10:15","1."));
        list.add(subList2);
