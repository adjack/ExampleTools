...
//        subList1.add(new StockInfo("<>士兰微",0,700,15.21,2,"20190830  14:09","1.5分钟回调过大，防范60分钟开始杀跌，2."));
...
//        subList4.add(new StockInfo("紫光国微",0,200,54.24,3,"20190828  10:25","1.日线前高并且5分钟背驰区域附近卖空 2"));
