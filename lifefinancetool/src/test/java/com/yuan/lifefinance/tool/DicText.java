...
//        subList1.add(new StockInfo("<>士兰微",14.74,700,0,9,"20190822  09:51","1.15分钟回调后有反弹，可能跟股北方华创"));
        subList1.add(new StockInfo("<>士兰微",14.45,700,14.12,5,"20190827  09:41","1.外围利空影响，减仓防范60分钟大跌风险2.重新买回有反弹趋势"));
        subList1.add(new StockInfo("<>士兰微",14.36,300,14.80,2,"20190827  10:31","1.5分钟有背驰趋势，考虑马上要出中报减仓防范，2.相对低位买回"));
        subList1.add(new StockInfo("<>士兰微",14.69,700,14.78,2,"20190829  10:41","1.5分钟前高有回调趋势卖空，2.5分钟回抽零轴附近买回"));
        //总结：每次交易做T应该要考虑空间，尽量做30分钟级别以上的高低位T,波动较小的做没有多大的意义--------------
        list.add(subList1);
