...
//               6-21&最近两天筹码松动，属于加仓后的继续上涨，关注回调机会
    ...
    public static String[] getMonth7NameArray(){
        ...
        String[] value = {
                ...
                "2019-07-[17-19]深天马A",//目标价格【15.87】止损价格【14.90】 最终收益：
...
//                  7-17&等待15分钟级别出1买
//                  7-18&等待15分钟级别出1买
//                  7-19&有出现反弹迹象，但是60分钟没有确认止跌，因为1分钟没有出3买，30分钟26.12有压力，收盘最后一个小时，继续弱势杀跌，60分钟继续寻底，当前点位非常关键，一旦跌破下跌空间大，卖出半仓

        List<StockInfo> list = new ArrayList<>();
        StockInfo stockInfo1 = new StockInfo("天齐锂业");
//------[开店买股1700]  20190716-》26.98
//        list.add(setStockInfo(stockInfo1,26.98,1700,15.25,2.0,"20190712  10:00","无"));
