...
public class DicText {
    ...
    public static String[] getMonth6NameArray(){
        ...
        String[] value = {
                "2019-06-[11-20亚盛股份]",//目标价格【5.10、3.91】止损价格【3.64】  最终收益：0.002
...
//               6-23&16.41属于类2买突破的压力位，如果跌破，虽然有机会继续形类2买，但是必须减仓防范杀跌风险，跌破要减仓
        };
        return value;
    }
 ...
 * 针对形成自己交易规则的几点思考方向
 * 1.需要形成规则
 *   短线规则：关注成交量必须上量，要符合成交量形态，要足够安全离止损位要近，目标空间需要20个点以上，尽量优先选龙头
 *   长线规则：个股必须是未来主流方向，比如科技，操作以周线级别操作，周线一笔中可以反复T，明确关注日线的压力与支撑,30分钟3买全力看多，30分钟3卖清仓
 * 2.坚定遵守规则
 * 3.执行规则
 *
 *
