...
public class ImageDownLoader {
    ...
    private ConcurrentHashMap<String, Integer> taskCollection;
    /** 缓存类 */
    ...
    public ImageDownLoader(Context context) {
        ...
        taskCollection = new ConcurrentHashMap<String, Integer>();
        // 创建线程数
     ...
     * @return
     */
    public ConcurrentHashMap<String, Integer> getTaskCollection() {
