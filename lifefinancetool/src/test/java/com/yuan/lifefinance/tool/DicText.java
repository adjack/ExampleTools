...
//                  止损。整板块有回拉动作，所以买入部分仓位，风险可控，一旦买错，依旧可以出局，当前等待大盘1分钟是否能出3买，一旦1分钟再拉回5分钟出3卖概率加大
    ...
    public static List<StockInfo> longTermTrack1_7(){//"2019-06-[14-？]四维图新"//目标价格【17.29】止损价格【14.15】 最终收益：
...
//                  总结：跌破重要点位马上出局，不能因为利好而迟疑，今天无量，应该不做T，错误操作，没有明确的目标，执行力不够
//                  7-09&【17.29-14.15】关注30分钟反弹，止损14.90
        List<StockInfo> list = new ArrayList<>();
        StockInfo stockInfo = new StockInfo("四维图新");
