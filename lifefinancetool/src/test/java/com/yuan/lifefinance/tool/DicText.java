...
//
    ...
    public void getSummaryDiary(){
        ...
        &:长线需要明确一种趋势的入口和出口，比如我们要做周线的一笔趋势，通常入口信号就是30分钟3买的形成，出口信号是30分钟的三卖形成
          ...
          A.【300分钟3买有机会时】满足此调整执行下一步,这个过程是为了确定周线开始上涨一笔，除了3买也可以通过日线1买确认止跌 但是要放量大阳线才行
                  ||
          B.【参考黄金分割位，等待5/15分钟1买买入部分仓位，需要严格止损防止三买失败】操作完成执行下一步，如果失败转向步骤A
                  ||
          C.【等待30分钟的一卖出局，1.参考5分钟的一买  2.或者一旦出现1分钟3卖5分钟反弹出局】操作完成执行下一步
                  ||
          D.【等待日线杀跌完成形成2买或者3买，1.等待5分钟出3买止跌  2.30分钟的1买】操作完成执行下一步，这个过程要防止出现30分钟出现3卖，一旦出现整段趋势可能就终结了
                  ||
